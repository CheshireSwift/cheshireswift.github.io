...
export function slime_mouseup(a: number, b: number, c: number): void;
export function slime_mousemove(a: number, b: number, c: number): void;
export function slime_color(a: number): void;
export function slime_width(): number;
export function slime_height(): number;
