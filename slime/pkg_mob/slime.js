...
export class Slime {
    ...
    */
    static new(agent_count) {
        const ret = wasm.slime_new(agent_count);
    ...
    */
    simulate(millis, ctx) {
        try {
            ...
            wasm.slime_simulate(retptr, this.__wbg_ptr, millis, addBorrowedObject(ctx));
